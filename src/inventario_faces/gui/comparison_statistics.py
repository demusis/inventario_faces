...
def _summary_popup_html(
    ...
    *,
    ...
    return (
        ...
        "</p>"
        "<p>"
        f"O <b>Padrão</b> é o conjunto de referência e deve conter um único indivíduo. "
        f"O agrupamento de controle encontrou <b>{summary.set_a_individuals}</b> agrupamento(s) "
        f"(esperado 1) — referência {'<b>homogênea</b>' if summary.reference_is_homogeneous else '<b>NÃO homogênea (revisar: possível imagem de outra pessoa)</b>'}. "
        "O <b>Questionado</b> não é agrupado por indivíduo: cada face/mídia é confrontada diretamente "
        "contra a referência."
        "</p>"
        "<p>"
